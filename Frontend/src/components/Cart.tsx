            ...
            {state.items.length === 0 ? (
              <div className="flex-1 flex items-center justify-center p-8 sm:p-6">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl sm:text-xl font-bold text-gray-800 mb-4 sm:mb-3">{t('cart.empty')}</h3>
                  <p className="text-lg sm:text-base text-gray-500 mb-8 sm:mb-6">{t('cart.empty.description')}</p>
                  <button
                    onClick={onClose}
                ...
                <div className="flex-shrink-0 bg-white border-t border-gray-200 p-8 sm:p-6 mb-24 sm:mb-20">
                  <div className="space-y-6 sm:space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-2xl sm:text-xl font-bold">{t('cart.total')}:</span>
