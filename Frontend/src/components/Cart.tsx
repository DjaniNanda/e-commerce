  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-end">
        <div className="bg-white h-full w-full max-w-lg overflow-hidden shadow-2xl animate-in slide-in-from-right duration-300">
          {/* Header */}
          <div className="sticky top-0 bg-white/95 backdrop-blur-sm border-b border-gray-100 px-6 py-6 flex items-center justify-between z-10">
          ...
          <div className="flex flex-col h-full">
            {state.items.length === 0 ? (
              ...
              <>
                ...
                <div className="flex-1 overflow-y-auto p-6 pb-4">
                  <div className="space-y-4">
                    {state.items.map((item) => (
                      <div key={item.product.id} className="bg-gray-50 rounded-2xl p-4 border border-gray-200 hover:shadow-md transition-all duration-200">
                ...
                <div className="flex-shrink-0 bg-white border-t border-gray-200 p-6 mb-20">
                  <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-xl border border-green-200">
                      <div className="flex items-center justify-center text-sm text-green-700 space-x-4">
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 rounded-2xl hover:from-blue-700 hover:to-blue-800 transition-all duration-200 font-bold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                    >
                      Passer la commande
                    </button>
                  </div>
