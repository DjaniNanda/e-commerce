          ...
          <div className="flex flex-col h-full">
            {state.items.length === 0 ? (
              ...
              <>
                ...
                <div className="flex-1 overflow-y-auto p-8 sm:p-6 pb-4">
                      ...
                      <div key={item.product.id} className="bg-gray-50 rounded-2xl p-6 sm:p-4 border border-gray-200 hover:shadow-md transition-all duration-200">
                        <div className="flex items-center space-x-6 sm:space-x-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-bold text-lg sm:text-base text-gray-800 truncate">{item.product.name}</h3>
                            <p className="text-base sm:text-sm text-gray-600">{item.product.category}</p>
                            <p className="text-xl sm:text-lg font-bold text-blue-600">{formatPrice(item.product.price)}</p>
                          </div>
                        </div>
                ...
                <div className="flex-shrink-0 bg-white border-t border-gray-200 p-8 sm:p-6 mb-20">
                  <div className="space-y-6 sm:space-y-4">
