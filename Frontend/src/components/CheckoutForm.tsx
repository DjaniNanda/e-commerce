      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-hidden">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-sm mt-1">Complétez vos informations pour procéder</p>
          </div>
          <button
            onClick={onClose}
            className="p-3 hover:bg-white/20 rounded-full transition-all duration-200 text-white hover:rotate-90"
          >
            <X className="h-6 w-6" />
          </button>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        value={formData.city}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 bg-white hover:border-gray-300"
                      >
              ...
              <div className="space-y-6">
                ...
                <div className="bg-green-50 rounded-xl p-4 border border-green-200">
                  <div className="flex items-center text-green-800">
                    ...
                    <span className="text-sm font-medium">Commande sécurisée</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t-2 border-gray-200">
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 rounded-xl hover:from-blue-700 hover:to-blue-800 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed transition-all duration-300 font-semibold flex items-center justify-center text-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] disabled:transform-none"
              >
                {isSubmitting ? (
                  <>
