      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-hidden">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-base sm:text-sm mt-1">Complétez vos informations pour procéder</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-[calc(95vh-100px)]">
          <form onSubmit={handleSubmit} className="p-10 sm:p-8">
            <div className="grid lg:grid-cols-3 gap-10 sm:gap-8">
              {/* Left Column - Forms */}
              <div className="lg:col-span-2 space-y-10 sm:space-y-8">
                ...
                <div className="bg-gray-50/50 rounded-xl p-8 sm:p-6 border border-gray-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 sm:gap-6">
                    <div className="space-y-3 sm:space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full px-5 py-4 sm:px-4 sm:py-3 text-lg sm:text-base border-2 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 ${
                          errors.firstName ? 'border-red-400 bg-red-50' : 'border-gray-200 bg-white hover:border-gray-300'
                        }`}
                        placeholder="Votre prénom"
                      />
                      {errors.firstName && (
                        <p className="text-red-500 text-base sm:text-sm flex items-center mt-1">
                  ...
                  <div className="mt-8 sm:mt-6 space-y-3 sm:space-y-2">
                    <label className="block text-base sm:text-sm font-semibold text-gray-700 flex items-center">
                ...
                <div className="bg-gray-50/50 rounded-xl p-8 sm:p-6 border border-gray-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 sm:gap-6 mb-8 sm:mb-6">
                    <div className="space-y-3 sm:space-y-2">
                      <label className="block text-base sm:text-sm font-semibold text-gray-700">
                        Ville *
                      </label>
                      <select
                        ...
                        value={formData.city}
                        onChange={handleInputChange}
                        className="w-full px-5 py-4 sm:px-4 sm:py-3 text-lg sm:text-base border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 bg-white hover:border-gray-300"
                      >
              ...
              <div className="space-y-8 sm:space-y-6">
                ...
                <div className="bg-white rounded-xl border-2 border-gray-200 overflow-hidden sticky top-4">
                  ...
                  <div className="p-8 sm:p-6">
                      ...
                      {state.items.map((item) => (
                        <div key={item.product.id} className="flex justify-between items-start">
                          <div className="flex-1">
                            <p className="font-medium text-lg sm:text-base text-gray-800 leading-tight">{item.product.name}</p>
                            <p className="text-base sm:text-sm text-gray-500 mt-2 sm:mt-1">Quantité: {item.quantity}</p>
                          </div>
                          <div className="text-right ml-6 sm:ml-4">
                    ...
                    <div className="border-t-2 border-gray-200 pt-6 sm:pt-4">
                      <div className="flex justify-between items-center">
                        <span className="text-xl sm:text-lg font-bold text-gray-800">Total:</span>
                        <span className="text-3xl sm:text-2xl font-bold text-blue-600">{formatPrice(state.total)}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 sm:p-6 border border-blue-200">
                  <h4 className="font-semibold text-lg sm:text-base text-blue-900 mb-6 sm:mb-4 flex items-center">
                    <CreditCard className="h-6 w-6 sm:h-5 sm:w-5 mr-3 sm:mr-2" />
                    Mode de paiement
                  </h4>
                  <div className="space-y-4 sm:space-y-3 text-base sm:text-sm">
                    <div className="flex items-center text-blue-800">
                      <div className="w-3 h-3 sm:w-2 sm:h-2 bg-blue-500 rounded-full mr-4 sm:mr-3"></div>
                      <span>Paiement à la livraison (Cash)</span>
                    </div>
                    <div className="flex items-center text-blue-800">
                      <div className="w-3 h-3 sm:w-2 sm:h-2 bg-green-500 rounded-full mr-4 sm:mr-3"></div>
                      <span>Livraison gratuite à Yaoundé</span>
                    </div>
                    <div className="flex items-center text-blue-800">
                      <div className="w-3 h-3 sm:w-2 sm:h-2 bg-orange-500 rounded-full mr-4 sm:mr-3"></div>
                ...
                <div className="bg-green-50 rounded-xl p-6 sm:p-4 border border-green-200">
                  <div className="flex items-center text-green-800">
                    ...
                    <span className="text-base sm:text-sm font-medium">Commande sécurisée</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10 sm:mt-8 pt-8 sm:pt-6 border-t-2 border-gray-200">
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-6 sm:py-4 rounded-xl hover:from-blue-700 hover:to-blue-800 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed transition-all duration-300 font-semibold flex items-center justify-center text-xl sm:text-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] disabled:transform-none"
              >
                {isSubmitting ? (
                  <>
              ...
              <p className="text-center text-base sm:text-sm text-gray-500 mt-4 sm:mt-3">
