          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div>
                ...
                <p className="text-base sm:text-sm text-gray-500 hidden sm:block font-medium">
          ...
          {!isAdminPage && (
            ...
            <div className="relative">
              ...
              <button
                onClick={(e) => handleSearch(e)}
                disabled={!searchQuery.trim()}
                className="absolute right-2 top-2 bottom-2 px-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 disabled:from-gray-400 disabled:to-gray-500 transition-all duration-200"
              >
